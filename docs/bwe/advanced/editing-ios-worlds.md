...
3. Click on your iPhone/iPad in Locations section of the sidebar.
    ...
    ![iPhone in the Locations section of the sidebar](/assets/images/advanced/editing-ios-worlds/iPhone_in_Finder_locations_sidebar.png)

4. Scroll down to the bottom of the General tab and check "Show this iPhone when on Wi-Fi".

    ![Show this iPhone when on Wi-Fi option checked at the bottom of the General tab](/assets/images/advanced/editing-ios-worlds/iPhone_Finder_enable_Wi-Fi_access.png)
...
You can find them [here](https://github.com/8Crafter-Studios/Bedrock-World-Editor/raw/refs/heads/main/.github/assets/scripts/macOS_iPhone_Minecraft_mounting_scripts.zip).
...
![iPhone Finder Files tab with app data in the list](/assets/images/advanced/editing-ios-worlds/iPhone_Finder_Files_tab_connected.png)\
