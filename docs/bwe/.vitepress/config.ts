...
export default defineConfigWithTheme<ThemeConfig>({
    title: "Bedrock World Editor Wiki",
    description: "The wiki for 8Crafter's Bedrock World Editor.",
    base: "/bwe/",
    ...
    themeConfig: {
        url: "https://wiki.8crafter.com/bwe",
        repository: "https://github.com/8Crafter-Studios/8Crafter-Wiki",
        repository_edit_link_base:
            "https://github.com/8Crafter-Studios/8Crafter-Wiki/blob/wiki/docs/bwe/",

        algolia: {
            appId: "97Y3M3Y6BI",
            apiKey: "84dd07d78c878c93eac11f7ed88ad9b8",
            indexName: "bwe",
            placeholder: "Search Bedrock World Editor Wiki...",
        },
