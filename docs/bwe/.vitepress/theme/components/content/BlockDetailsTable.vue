            ...
            <tbody>
                ...
                <tr v-if="!!props.renewable">
                    <th title="Whether or not the block is renewable.">
                        <a href="https://minecraft.wiki/w/Renewable_resource" target="_blank"
                            >Renewable</a
                        >
                    </th>
                    <td>
                ...
                <tr v-if="!!props.blastResistance">
                    <th title="The block's blast resistance.">
                        <a
                            href="https://minecraft.wiki/w/Explosion#Blast_resistance"
                            target="_blank"
                        >
                            Blast resistance
                        </a>
                ...
                <tr v-if="!!props.hardness">
                    <th title="The block's hardness.">
                        <a
                            href="https://minecraft.wiki/w/Breaking#Blocks_by_hardness"
                            target="_blank"
                        >
                            Hardness
                        </a>
                ...
                <tr v-if="!!props.waterloggable">
                    <th title="Whether or not the block is waterloggable.">
                        <a href="https://minecraft.wiki/w/Waterlogging" target="_blank"
                            >Waterloggable</a
                        >
                    </th>
                ...
                <tr v-if="!!props.catchesFireFromLava">
                    <th title="Whether or not the block catches fire from lava.">
                        Catches fire from
                        <a href="https://minecraft.wiki/w/Lava" target="_blank">lava</a>
                    </th>
                    <td>
