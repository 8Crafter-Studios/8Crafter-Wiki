        ...
        Object.assign(
            ...
            userOptions as Parameters<typeof docsearch>[0],
            {
                ...
                hitComponent: ({ hit, children }: { hit: any; children: any }) => {
                    const relativeHit =
                        hit.url.startsWith("http") ? getRelativePath(hit.url as string) : hit.url;
                    return {
                        type: "a",
                        ref: undefined,
...
.DocSearch-Form:hover {
    border-image: url("/assets/images/ui/textboxes/edit_box_indent_hover.png") 2 1 2 1 fill / 4px
        2px 4px 2px;
}
