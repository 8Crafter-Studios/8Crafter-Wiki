...
If you are on a realm, try restarting the realm.

If you are on a world or server, run the [`/reload`{lang=mccmd}](https://minecraft.wiki/w/Commands/reload) commands, or restart the world or server.
...
<Spoiler title="The custom commands aren't working.">

### Step 1

Try running `\help`{lang=mccmd} in the chat.

If that works, then you probably just didn't have permission to use the command that wasn't working, see [this page](../commands/commands-basics#how-to-give-players-the-permissions-to-use-commands) for information on how to give players the permissions to use the commands.

If it just says `\help` in the chat, continue to step 2.
