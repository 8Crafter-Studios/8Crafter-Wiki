        ...
        <table cellspacing="1" cellpadding="4">
            <tbody>
                ...
                <tr v-if="!!props.ultraSecurityModeSecurityLevel">
                    ...
                    >
                        <a
                            href="/andexdb/usm/command-required-permission-levels"
                ...
                <tr>
                    ...
                    <td>
                        <code v-for="(entry, i) in props.requiredTags" :key="i"
                            >{{ entry }}<br
                        /></code>
                ...
                <tr>
                    ...
                    <td>
                        {{
                            props.undoSupported === -1 ? "N/A"
                            : props.undoSupported == 0 ? "No"
                            : props.undoSupported === 1 ? "Yes"
                            : "?"
                        }}
                    </td>
                </tr>
