...
<FolderView :paths="[
    ...
    'theme/textures/hbui/assets/example.gif',
    'theme/textures/example.svg',
    'theme/textures/hbui/assets/example.svg',
    // 'theme/textures/example.tga', // <!-- TODO: See if .tga images are supported. -->
    // 'theme/textures/hbui/assets/example.tga',
    'theme/textures/example.png',
    'theme/textures/hbui/assets/example.png',
    'theme/textures/example.jpg',
    'theme/textures/hbui/assets/example.jpg',
    'theme/textures/example.jpeg',
    'theme/textures/hbui/assets/example.jpeg',
    // 'theme/sounds/example.ogg',
    // 'theme/sounds/hbui/assets/example.ogg',
    // 'theme/sounds/example.mp3',
    // 'theme/sounds/hbui/assets/example.mp3',
    // 'theme/sounds/example.wav',
    // 'theme/sounds/hbui/assets/example.wav',
    // 'theme/sounds/example.fsb',
    // 'theme/sounds/hbui/assets/example.fsb',
    'theme/videos/example.webm',
    'theme/videos/hbui/assets/example.webm',
    'theme/font/*.otf',
    'theme/font/*.ttf',
...
<FolderView :paths="[
    ...
    'theme.ouictheme/textures/hbui/assets/example.gif',
    'theme.ouictheme/textures/example.svg',
    'theme.ouictheme/textures/hbui/assets/example.svg',
    // 'theme.ouictheme/textures/example.tga', // <!-- TODO: See if .tga images are supported. -->
    // 'theme.ouictheme/textures/hbui/assets/example.tga',
    'theme.ouictheme/textures/example.png',
    'theme.ouictheme/textures/hbui/assets/example.png',
    'theme.ouictheme/textures/example.jpg',
    'theme.ouictheme/textures/hbui/assets/example.jpg',
    'theme.ouictheme/textures/example.jpeg',
    'theme.ouictheme/textures/hbui/assets/example.jpeg',
    // 'theme.ouictheme/sounds/example.ogg',
    // 'theme.ouictheme/sounds/hbui/assets/example.ogg',
    // 'theme.ouictheme/sounds/example.mp3',
    // 'theme.ouictheme/sounds/hbui/assets/example.mp3',
    // 'theme.ouictheme/sounds/example.wav',
    // 'theme.ouictheme/sounds/hbui/assets/example.wav',
    // 'theme.ouictheme/sounds/example.fsb',
    // 'theme.ouictheme/sounds/hbui/assets/example.fsb',
    'theme.ouictheme/videos/example.webm',
    'theme.ouictheme/videos/hbui/assets/example.webm',
