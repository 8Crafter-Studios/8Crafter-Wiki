...
export default defineConfigWithTheme<ThemeConfig>({
    title: "Ore UI Customizer Wiki",
    description: "The wiki for 8Crafter's Ore UI Customizer.",
    base: "/ouic/",
    ...
    themeConfig: {
        url: "https://wiki.8crafter.com/ouic",
        repository: "https://github.com/8Crafter-Studios/8Crafter-Wiki",
        repository_edit_link_base:
            "https://github.com/8Crafter-Studios/8Crafter-Wiki/blob/wiki/docs/ouic/",

        algolia: {
            appId: "97Y3M3Y6BI",
            apiKey: "84dd07d78c878c93eac11f7ed88ad9b8",
            indexName: "main",
            placeholder: "Search Ore UI Customizer Wiki...",
        },
