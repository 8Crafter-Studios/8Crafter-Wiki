...
// Exports the prettier v3.3.3 Markdown language.
export const languages = [prettier333MarkdownPlugin.languages.find((language) => language.name === "Markdown")];
// Exports the prettier v3.3.3 Markdown options.
export const options = prettier333MarkdownPlugin.options;
